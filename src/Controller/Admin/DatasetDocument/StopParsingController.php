 ...
 * 停止解析文档
 */
final class StopParsingController extends AbstractController
{
    ...
    #[Route(path: '/admin/datasets/{datasetId}/documents/{documentId}/stop-parsing', name: 'dataset_documents_stop_parsing', methods: ['POST'])]
